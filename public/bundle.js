...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
		...
		setTerm: function setTerm(top, start, end) {
			this.setState({
				topic: top,
				startYear: start,
				endYear: end
		...
		savedArticles: function savedArticles(title, date, url) {
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'row' },
					React.createElement(Results, { results: this.state.results, savedArticles: this.savedArticles })
				),
				React.createElement(
					'div',
					{ className: 'row' },
	...
	var Results = React.createClass({
		...
		componentWillReceiveProps: function componentWillReceiveProps(newProps) {
			...
			var myResults = newProps.results(function (search, i) {
				...
				return React.createElement(
					"div",
					{ className: "listOfArticles", key: i },
					search.title,
					React.createElement("br", null),
					search.date,
					React.createElement("br", null),
					...
					React.createElement(
						"button",
						{ type: "button", className: "btn btn-warning", onClick: boundClick },
						"Save"
					)
				);
			});
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'h1',
						null,
						this.props.savedArticles(function (search, i) {
							return React.createElement(
								'div',
								{ className: 'listOfArticles', key: i },
								search.title,
